  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Sınıfı Sil</h3>
        ...
        {classes.map((classroom) => (
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-4 bg-gray-50 p-2 rounded-md">
              <span className="text-sm text-gray-600">Sınıf ID:</span>
            ...
            <div className="flex items-center gap-4 text-sm text-gray-600 mb-4">
              <div>
                <span className="font-medium">{classroom.students.length}</span> öğrenci
              </div>
              <div>
                Toplam Puan:{' '}
