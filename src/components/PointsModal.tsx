...
const behaviors: Behavior[] = [
  { id: '1', description: 'Derse aktif katılım', points: 2, type: 'positive' },
  { id: '2', description: 'Ödev tamamlama', points: 1, type: 'positive' },
  { id: '3', description: 'Arkadaşlarına yardım etme', points: 2, type: 'positive' },
  { id: '4', description: 'Sınıf kurallarına uyma', points: 1, type: 'positive' },
  { id: '5', description: 'Derse geç kalma', points: -1, type: 'negative' },
  { id: '6', description: 'Ödev yapmama', points: -1, type: 'negative' },
  { id: '7', description: 'Sınıfı rahatsız etme', points: -2, type: 'negative' },
  { id: '8', description: 'Arkadaşlarına saygısızlık', points: -2, type: 'negative' },
];
    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Mevcut Puan: {student.points}</p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="text-lg font-medium text-green-600 mb-4">Olumlu Davranışlar</h4>
          ...
          <div>
            <h4 className="text-lg font-medium text-red-600 mb-4">Olumsuz Davranışlar</h4>
            <div className="space-y-2">
        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-2">
            <h4 className="text-lg font-medium text-gray-900">Öğrenci Notları</h4>
            <button
